...
resume: FORCE
	pandoc -f markdown -o harper-resume.pdf --template=default.latex --variable geometry=margin=1in src/header.md src/summary.md src/education.md src/professional.md src/pubs-short.md src/research-service-short.md
