...
resume: FORCE
	pandoc -f markdown -o harper-resume.pdf --template=default.latex --variable geometry=margin=1in src/header-resume.md src/summary.md src/education-short.md src/professional.md src/pubs-short.md src/research-service-short.md
